  ...
  */
	...
	async getOSVersion() {
		switch (this.getPlatform()) {
			case "darwin": return this.macVersionText();
			case "win32": return this.winVersionText();
			case "linux": return this.linuxVersionText();
			default: return `${os.platform()} ${os.release()}`;
		}
	},
		...
		return new Promise(resolve => {
			...
			const systemInfo = new BufferedProcess({
				...
				exit() {
					...
					resolve(version ? version[1] : "Unknown Windows version");
				}
			});
