...
import {Notification, CompositeDisposable} from "atom";
...
`;
	...
	createLog(state) {
		this.notificationsLog = new NotificationsLog(this.getDedupedNotifications(), state ? state.typesHidden : null);
	...
	statusBarService(statusBar) {
		this.statusBarManager = new StatusBarManager(statusBar, this.getDedupedNotifications());
	},
